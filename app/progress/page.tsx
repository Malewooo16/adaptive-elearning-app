      ...
      <div className="max-w-6xl mx-auto p-6 bg-orange-50 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card
            ...
            value={knowledgeStates.length}
            color="orange"
          />
          <Card
            icon={Target}
            title="Overall Accuracy"
            value={`${Math.round((insights?.accuracy ?? overallAccuracy) * 100)}%`}
            color="green"
          />
          <Card
            icon={Clock}
          ...
          <Card
            icon={Award}
            title="Avg Mastery"
            value={`${Math.round(avgSkillMastery * 100)}%`}
            color="blue"
          />
        </div>
