...
const UserProgressDashboarde = async () => {
  ...
  return (
    <div className="mx-auto py-6 px-10 bg-gradient-to-b from-orange-50 to-orange-100 min-h-screen">
     ...
     <div className="w-full flex justify-center m-4 mx-auto">  <button className="px-6 py-3 bg-[#f97316] text-white font-semibold rounded-lg shadow hover:bg-[#ea580c] transition">
